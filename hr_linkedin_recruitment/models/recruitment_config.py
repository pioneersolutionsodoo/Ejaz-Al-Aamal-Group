...
class ResConfigSettings(models.TransientModel):
    ...
    li_code = fields.Char(string="Code", help="Code Coming From Authentication")
    li_access_token = fields.Char(string="Access Token", help="Access Token Authentication From Linkedin App")
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('recruitment.li_code', self.li_code)
        self.env['ir.config_parameter'].sudo().set_param('recruitment.li_access_token', self.li_access_token)
